			...
			<div class="panel-body">
				...
				<!--form action="http://ebro-admin.tzdthemes.com/" id="parsley_reg"-->
                    ...
                    <div class="form_sep">
						...
						<input type="text" id="username" name="username" class="form-control" data-required="true" value="<?php if(!empty($username)){ echo $username;} ?>" />
					...
					<div class="form_sep">
						<div class="form-group">
							<label for="reg_password" class="req">Password</label>
							<!--input type="text" name="reg_password" id="reg_password" class="form-control" data-required="true" data-minlength="8"-->
                            <div class="col-sm-4">
                                <div class="form-group">
    								<input type="password" name="user_password" id="password_meter" class="form-control" data-required="true"  />
                    ...
                    <div class="form_sep">
						...
						<input type="password" name="reg_password_repeat" id="reg_password_repeat" class="form-control" data-required="true" data-equalto="#password_meter" />
					...
					<div class="form_sep">
                        ...
                        <?php $whereString = array('role_is_active' => 1,'role_is_deleted' => 0);
                         ...
                         echo dropdownMenu('','role_id','users','role','role_title',$whereString,$attribute); ?>
					...
					<div class="form_sep">
            			...
            			<?php if(empty($is_active)) { $is_active = '1';}?>
