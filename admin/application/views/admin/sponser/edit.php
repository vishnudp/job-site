  ...
  <div class="col-sm-5">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
         <?php echo form_open_multipart('',array('name' => 'sponser_form', 'id' => 'sponser_form'));?>
          <div class="form_sep">
            <label for="category_title" class="req">Title </span></label>
            <input type="text" id="sponser_title" name="sponser_title" value="<?php echo set_value('sponser_title',$sponser_title); ?>" class="form-control" data-required="true" />
            <span class="required-server"><?php echo form_error('sponser_title'); ?> </div>
          <div class="form_sep">
            <label for="category_description" class="req">Url</label>
			 <input type="text" id="sponser_url" name="sponser_url" value="<?php echo set_value('sponser_url',$sponser_url); ?>" class="form-control" data-required="true" />
            <span class="required-server"><?php echo form_error('sponser_url'); ?></span> </div>			
			<?php 
			if(isset($sponser_image) && !empty($sponser_image) && file_exists('./uploads/sponser/'.$sponser_image) ){?>
			<div class="form_sep">
            <div class="form-group">
              ...
              <div class="input-group">
				...
				<img src="<?php echo base_url().'uploads/sponser/'.$sponser_image;?>" height="100" width="100">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <div class="input-group-btn"> <span class="btn btn-default btn-file"> <span class="fileupload-new">Select</span>
                  <input type="file" name="sponser_image" id="sponser_image" value="<?php echo set_value('sponser_image',$sponser_image); ?>" />
                  </span> <span class="required-server"><?php echo form_error('sponser_image'); ?></span> </div>
              </div>
            </div>
          </div>
          ...
          <div class="form_sep">
			...
			<?php $sponser_is_active = set_value('sponser_is_active',$sponser_is_active); ?>
