...
<div class="row">
  <div class="col-sm-5">
    <div class="panel panel-default">
      ...
      <div class="panel-body"> <?php echo form_open_multipart('',array('name' => 'logo_form', 'id' => 'logo_form'));?>
        <div class="form_sep">
          <label for="category_title" class="req">Title </span></label>
          <input type="text" id="logo_title" name="logo_title" value="<?php echo set_value('logo_title'); ?>" class="form-control" data-required="true" />
          <span class="required-server"><?php echo form_error('logo_title'); ?> </div>
        <div class="form_sep">
          <label for="category_description" class="req">Url</label>
          <input type="text" id="logo_url" name="logo_url" value="<?php echo set_value('logo_url'); ?>" class="form-control" data-required="true" />
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <div class="form-control"> <i class="icon-file fileupload-exists"></i> <span class="fileupload-preview"></span>
                  <?php if(isset($logo_image) && !empty($logo_image)){ echo set_value('logo_image',$logo_image); } ?>
                 </div>
                <div class="input-group-btn"> <span class="btn btn-default btn-file"> <span class="fileupload-new">Select</span>
                  <input type="file" name="logo_image" id="logo_image" value="<?php echo set_value('logo_image'); ?>" />
                  </span> <span class="required-server"><?php echo form_error('logo_image'); ?></span> </div>
              </div>
            </div>
          </div>
      ...
      <div class="form_sep">
        ...
        <div class="form_sep">
		  ...
		  if($logo_is_active == '') { $logo_is_active = '1';}?>
