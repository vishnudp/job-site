...
<?php }else{ ?>	
	...
	<label id="<?php echo $value['option_id']; ?>" onclick="getAnswer('<?php echo $value['option_id']; ?>','<?php echo $value['question_id']; ?>','<?php echo $page; ?>');">
		<input type="radio" name="option" <?php echo $answerActive; ?> value="<?php echo $value['option_value']; ?>" /><a class="group1" href="<?php echo $src_image ?>" title=""><img class="option-img" width="120" style="margin-top:15px;"  src="<?php echo $src_image; ?>" /></a>
	</label>
