...
<a href="<?php echo base_url(); ?>plan">Sign up</a><a href="<?php echo base_url(); ?>signin">Sign in</a>
<?php }else{ ?>
<a href="<?php echo base_url(); ?>dashboard" title="My Dashboard">My Dashboard</a><a href="<?php echo base_url(); ?>signout">Logout</a>
<?php } ?>
</div>
